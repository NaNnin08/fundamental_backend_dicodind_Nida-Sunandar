...
const mapDB = require("../../utils/index");
...
class SongsSevice {
  ...
  async saveSong({ title, year, performer, genre, duration }) {
    ...
    if (!result.rows[0].id) {
      throw new InvariantError("Lagu gagal ditambahkan kedatabase");
    }
  ...
  async getSongById(id) {
    ...
    return result.rows.map(mapDB.mapDBToModelGetById)[0];
  }
